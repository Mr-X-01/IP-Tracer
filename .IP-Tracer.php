...
function About() {
  ...
  echo <<<EOL
         ...
         \033[01;33mAuthor \033[01;37m:- \033[01;36mMr. X
...
function upd() {
  ...
  sleep(1);
  system("cd ~/ && git clone https://github.com/Mr-X-01/IP-Tracer.git");
  system("cd ~/ && sudo git clone https://github.com/Mr-X-01/IP-Tracer.git");
